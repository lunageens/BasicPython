...
1. *Git downloaden*: Ga naar git-scm.com, kies "Downloads" en selecteer "Windows". Download de "64-bit Git for Windows Setup". Voer het gedownloade installatieprogramma uit en volg de instructies. Kies de standaardopties voor een eenvoudige installatie.
